...
void setup() {
  ...
  startBlink(strip.Color(128, 0, 0)); // cyan
}
...
void loop() {
 ...
 theaterChase2(strip.Color(0, 127, 127), 75); // Red
  //theaterChase(strip.Color(0, 0, 127), 50); // Blue
 // delay(500);
  //rainbow(20);
  //rainbowCycle(10);
  //theaterChaseRainbow(50);
  extendOff(strip.Color(0, 127, 127), 20);
 // allOff(1000);
 // exit(1);
 delay(1500);
...
void extendOff(uint32_t c, uint8_t wait) {
  //for (int i=0; i < strip.numPixels(); i++) {
  //      strip.setPixelColor(i, c);   
  //    }
  // strip.show();
